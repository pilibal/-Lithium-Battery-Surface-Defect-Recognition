...
if __name__ == "__main__":
    ...
    if model_path != '':
        ...
        if local_rank == 0:
            ...
            print("\n\033[Note: It is normal for the head section not to load; however, it is an error if the Backbone section fails to load.\033[0m")
    ...
    if local_rank == 0:
        ...
        if total_step <= wanted_step:
            ...
            print("\033[1;33;44m[Warning] The total training data for this run is %d, with Unfreeze_batch_size set to %d, training for %d Epochs in total, resulting in %d total training steps.\033[0m"%(num_train, Unfreeze_batch_size, UnFreeze_Epoch, total_step))
            print("\033[1;33;44m[Warning] Since the total training steps are %d, which is less than the recommended %d, it is recommended to set the total epochs to %d.\033[0m"%(total_step, wanted_step, wanted_epoch))
